...
public class IncompleteListIcon : NSObject {
    ...
    public dynamic class var imageOfCompleteListIconSelected: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 150, height: 150), false, 0)
            IncompleteListIcon.drawCompleteListIconSelected()
    ...
    public dynamic class var imageOfIncompleteListIconSelected2: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 150, height: 150), false, 0)
            IncompleteListIcon.drawIncompleteListIconSelected2()
    ...
    public dynamic class var imageOfCompleteListIconUnselected: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 150, height: 150), false, 0)
            IncompleteListIcon.drawCompleteListIconUnselected()
    ...
    @IBOutlet dynamic var completeListIconSelectedTargets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: IncompleteListIcon.imageOfCompleteListIconSelected)
            }
        }
    }
    ...
    @IBOutlet dynamic var incompleteListIconSelected2Targets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: IncompleteListIcon.imageOfIncompleteListIconSelected2)
            }
        }
    }
    ...
    @IBOutlet dynamic var completeListIconUnselectedTargets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: IncompleteListIcon.imageOfCompleteListIconUnselected)
            }
        }
    }
